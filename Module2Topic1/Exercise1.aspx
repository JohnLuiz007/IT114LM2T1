...
<body>
    ...
    <form runat="server">
        ...
        <asp:Label ID="song" runat="server" Text ="Never Gonna Give You Up"></asp:Label>
        <br />
        ...
        <asp:ImageButton ID="fav_song" runat="server" ImageUrl="https://variety.com/wp-content/uploads/2021/07/Rick-Astley-Never-Gonna-Give-You-Up.png" Height ="200px" Width="200px" AlternateText ="Rick Roll"/>
        ...
        <asp:Button ID="Play" runat="server" onclick="Play_fave_song" Text="Play"/>
        ...
        <span runat="server" id ="play_song"></span>
        <br />
